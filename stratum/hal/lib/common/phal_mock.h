...
class PhalMock : public PhalInterface {
 public:
  ...
  MOCK_METHOD3(GetOpticalChannelInfo,
               ::util::Status(int module, int network_interface, OpticalChannelInfo* optical_netif_info));
  MOCK_METHOD3(SetOpticalChannelInfo,
