...
class SwitchInterface {
 public:
  ...
  // ::p4::v1::ForwardingPipelineConfig proto passed to this method is generated by
  ...
  virtual ::util::Status WriteForwardingEntries(
      const ::p4::v1::WriteRequest& req, std::vector<::util::Status>* results) = 0;
  ...
  // This method can be called only after a successful call to
  // PushForwardingPipelineConfig(). The given ::p4::v1::ReadRequest will include
  ...
  // ::p4::v1::PacketIn instance includes all the info on where the packet was
  // received on this node as well as its payload.
  virtual ::util::Status RegisterPacketReceiveWriter(
      uint64 node_id,
      const std::shared_ptr<WriterInterface<::p4::v1::PacketIn>>& writer) = 0;
  ...
  // to let the chip route the packet. The given ::p4::v1::PacketOut instance
