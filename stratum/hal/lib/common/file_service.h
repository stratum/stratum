...
#ifndef THIRD_PARTY_STRATUM_HAL_LIB_COMMON_FILE_SERVICE_H_
#define THIRD_PARTY_STRATUM_HAL_LIB_COMMON_FILE_SERVICE_H_
...
#endif  // THIRD_PARTY_STRATUM_HAL_LIB_COMMON_FILE_SERVICE_H_
