...
class P4WriteRequestReporter
    : public ::google::google::protobuf::util::MessageDifferencer::Reporter {
 public:
  // This type simplifies the declaration of the member overrides below.
  typedef std::vector<
      ::google::google::protobuf::util::MessageDifferencer::SpecificField>
      FieldVector;
  ...
  void ReportAdded(const ::google::google::protobuf::Message& message1,
                   const ::google::google::protobuf::Message& message2,
                   const FieldVector& field_path) override;

  // Reports that a field has been deleted from message1.
  void ReportDeleted(const ::google::google::protobuf::Message& message1,
                     const ::google::google::protobuf::Message& message2,
                     const FieldVector& field_path) override;

  // Reports that a field in message1 has been modified by message2.
  void ReportModified(const ::google::google::protobuf::Message& message1,
                      const ::google::google::protobuf::Message& message2,
                      const FieldVector& field_path) override;

  // Reports that a field in message1 has been moved in message2, but no
  // other changes exist.
  void ReportMoved(const ::google::google::protobuf::Message& message1,
                   const ::google::google::protobuf::Message& message2,
                   const FieldVector& field_path) override;

  // Reports that message1 and message2 match.
  void ReportMatched(const ::google::google::protobuf::Message& message1,
                     const ::google::google::protobuf::Message& message2,
                     const FieldVector& field_path) override;
...
class P4WriteRequestComparator
    : public ::google::google::protobuf::util::MessageDifferencer::MapKeyComparator {
 public:
  P4WriteRequestComparator() {}
  ~P4WriteRequestComparator() override{};

  bool IsMatch(const ::google::google::protobuf::Message& message1,
               const ::google::google::protobuf::Message& message2,
               const std::vector<
                   ::google::google::protobuf::util::MessageDifferencer::SpecificField>&
