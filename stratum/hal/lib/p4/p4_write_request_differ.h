...
// The P4WriteRequestDiffer class compares a pair of p4::WriteRequest messages.
// Its typical use case is to find any differences between p4::WriteRequests
...
class P4WriteRequestDiffer {
 public:
  ...
  P4WriteRequestDiffer(const p4::WriteRequest& old_request,
  ...
  ::util::Status Compare(p4::WriteRequest* delete_request,
                         p4::WriteRequest* add_request,
                         p4::WriteRequest* modify_request,
                         p4::WriteRequest* unchanged_request);
 ...
 private:
  ...
  ::util::Status DoCompare(p4::WriteRequest* delete_request,
                           p4::WriteRequest* add_request,
                           p4::WriteRequest* modify_request,
                           p4::WriteRequest* unchanged_request);
  ...
  void FillOutputFromReporterIndexes(const p4::WriteRequest& source_request,
  ...
  const p4::WriteRequest& old_request_;
  const p4::WriteRequest& new_request_;
};
