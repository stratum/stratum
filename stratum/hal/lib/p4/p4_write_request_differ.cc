...
bool P4WriteRequestComparator::IsMatch(
    const protobuf::Message& message1, const protobuf::Message& message2,
    const std::vector<protobuf::util::MessageDifferencer::SpecificField>&
    parent_fields) const {
  const ::p4::v1::Update& update1 =
      *protobuf::internal::DynamicCastToGenerated<const ::p4::v1::Update>(
          &message1);
