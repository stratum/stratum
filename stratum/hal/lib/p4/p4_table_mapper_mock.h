...
class P4TableMapperMock : public P4TableMapper {
 public:
  ...
  MOCK_CONST_METHOD2(MapActionProfileMember,
                     ::util::Status(const ::p4::ActionProfileMember& member,
                                    MappedAction* mapped_action));
  MOCK_CONST_METHOD2(MapActionProfileGroup,
                     ::util::Status(const ::p4::ActionProfileGroup& group,
                                    MappedAction* mapped_action));
  MOCK_CONST_METHOD2(
  ...
  MOCK_CONST_METHOD2(
      ...
      ::util::Status(const ::p4::PacketMetadata& p4_packet_metadata,
  ...
  MOCK_CONST_METHOD2(LookupTable,
                     ::util::Status(int table_id, ::p4::config::Table* table));
