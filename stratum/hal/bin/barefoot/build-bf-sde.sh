...
Examples:
    ...
    $0 -t ~/bf-sde-9.7.1.tgz
    $0 -t ~/bf-sde-9.7.1.tgz -j 4
    $0 -t ~/bf-sde-9.7.1.tgz -k ~/linux-4.14.49-ONL.tar.xz
"
}

function numeric_version() {
  # Get numeric version, for example 9.7.1 will become 90701.
  sem_ver=$1
  ver_arr=()
