...
For example, the container with BF SDE 9.3.1: <br/>
`stratumproject/stratum-bf:9.3.1`
...
```bash
docker load -i stratum-bf-9.3.1-docker.tar
```
...
docker run --rm -it --privileged \
  --network=host \
  stratumproject/tofino-model:9.3.1  # <SDE_VERSION>
```
