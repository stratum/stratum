...
ENV PKG_DEPS pkg-config zip g++ zlib1g-dev unzip python wget ca-certificates python-yaml libyaml-dev
...
RUN bazel build @com_github_p4lang_p4runtime//:p4runtime_cc_grpc
# RUN bazel build ...
